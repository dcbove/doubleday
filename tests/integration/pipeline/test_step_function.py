...
until completion. Unlike the Lambda-level integration tests which invoke
individual Lambdas, these verify the full orchestration: that the Step Function
correctly chains Lambdas, passes state between steps, and handles input
validation failures by stopping early.
