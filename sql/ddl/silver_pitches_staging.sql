-- statcast_pitches_staging: transient scratch table for idempotent merges
-- Load one (season, game_date) at a time, MERGE into canonical, then DELETE.
CREATE TABLE IF NOT EXISTS silver_pitches_staging (
  -- identifiers
  game_pk                                    bigint,
  at_bat_number                              int,
  pitch_number                               int,
