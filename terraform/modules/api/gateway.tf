...
resource "aws_api_gateway_deployment" "main" {
  ...
  triggers = {
    redeployment = sha1(jsonencode(concat(
      ...
      var.enable_stripe ? [
        aws_api_gateway_resource.subscriptions_checkout[0],
        aws_api_gateway_method.post_checkout[0],
        aws_api_gateway_integration.post_checkout[0],
        aws_api_gateway_method.options_checkout[0],
        aws_api_gateway_integration.options_checkout[0],
        aws_api_gateway_resource.subscriptions_portal[0],
        aws_api_gateway_method.post_portal[0],
        aws_api_gateway_integration.post_portal[0],
        aws_api_gateway_method.options_portal[0],
        aws_api_gateway_integration.options_portal[0],
      ] : [],
    )))
  }
