...
resource "aws_api_gateway_deployment" "main" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.stripe,
      aws_api_gateway_resource.stripe_webhook,
      aws_api_gateway_method.post_stripe_webhook,
      aws_api_gateway_integration.post_stripe_webhook,
      aws_api_gateway_method.options_stripe_webhook,
      aws_api_gateway_integration.options_stripe_webhook,
