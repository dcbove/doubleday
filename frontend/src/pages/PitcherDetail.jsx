...
export default function PitcherDetail() {
  ...
  return (
    <div>
      ...
      {/* Two-column layout: bio + graph on left, similar pitchers on right */}
      <div className="flex flex-col gap-4 sm:grid sm:grid-cols-[400px_1fr] sm:grid-rows-[520px] sm:gap-6">
        ...
        {neighborsLoading && (
          <p className="text-sm text-gray-400">
            Loading similar pitchers...
          </p>
        )}
        {neighbors && neighbors.length > 0 && (
          <div className="flex min-w-0 flex-col overflow-hidden">
            <h2 className="mb-1.5 shrink-0 text-sm font-semibold text-gray-900">
